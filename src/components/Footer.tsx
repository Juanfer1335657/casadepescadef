    ...
    <footer style={{
      ...
      <div className="container">
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <a 
                href="mailto:jofejuanfer144@gmail.com"
                style={{ 
                  display: 'flex', 
                  alignItems: 'center', 
                  gap: '8px',
          ...
          <div>
            ...
            <div style={{ color: '#aec9ea', fontSize: '14px', lineHeight: 1.8 }}>
        ...
        <div style={{
          ...
          <p style={{ color: '#aec9ea', fontSize: '14px' }}>
            © 2024 La Casa de Pesca. Todos los derechos reservados.
          </p>
          {showAdminLink && (
            <a 
              href="/admin" 
